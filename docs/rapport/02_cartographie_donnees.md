...
| data/raw/ | data/processed/ | Post-ingest | ~5 fichiers Silver | Parquet |
| data/processed/ | data/output/ | Post-transform | ~3 fichiers Gold | JSON |
...
`pipeline` dans docker-compose sert uniquement au chargement initial.
...
## 9. Conformite au referentiel C2

| Critere d'evaluation | Statut | Preuve |
|---------------------|--------|--------|
| Inventaire exhaustif des sources | ✅ | Section 1 (6 sources detaillees) |
| Semantique / glossaire metier | ✅ | Section 2 (4 sous-glossaires) |
| Modeles de donnees (Bronze/Silver/Gold) | ✅ | Section 3 (schemas complets) |
| Modele dimensionnel (star schema) | ✅ | Section 4 (fact + 2 dimensions + dbt) |
| Flux de donnees et traitements | ✅ | Section 5 (batch, trad, streaming, dbt) |
| Mise a disposition et acces | ✅ | Section 6 (10 methodes d'acces) |
| Qualite des donnees | ✅ | Section 7 (validation 3 niveaux) |
| Donnees manquantes identifiees | ✅ | Section 8 (7 lacunes documentees) |
