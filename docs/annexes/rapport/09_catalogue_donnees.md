...
| Layer 1 / Infrastructure | ATOMUSDT, NEARUSDT, APTUSDT, SUIUSDT, INJUSDT, THETAUSDT, ALGOUSDT, VETUSDT, SEIUSDT, HBARUSDT | 10 |
| DeFi | AAVEUSDT, UNIUSDT, DYDXUSDT, SNXUSDT, WLDUSDT, COMPUSDT, SUSHIUSDT, CRVUSDT, LDOUSDT, PENDLEUSDT, ENSUSDT | 11 |
| Layer 2 / Scaling | POLUSDT, ARBUSDT, OPUSDT | 3 |
...
|------|-----------|-----------|-------------|
| Bronze (batch) | 10 ans    | Non | Automatique (script) |
| Bronze (streaming) | 10 ans | Non | Automatique |
| Silver | 10 ans | Non | Automatique |
| Gold | 10 ans  | Non | Ecrasement a chaque execution |
