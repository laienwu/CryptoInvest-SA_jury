...
| Critère | Airflow | Prefect | Dagster | Cron | Actions GitHub |
|-----------|---------|---------|---------|------|----------------|
...
- Moins de présence sur le marché
...
|-----------------|-----|-----------------|
| Succès de l'exécution du DAG | Interface utilisateur du Airflow | Tout échec |
...
- [Meilleures pratiques en matière de Airflow](https://airflow.apache.org/docs/apache-airflow/stable/best-practices.html)
- [Exécuter le Airflow dans Docker](https://airflow.apache.org/docs/apache-airflow/stable/howto/docker-compose/index.html)
